...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/login", "/logout", "/register", "/animes", "/animes/**", "/lists", "/lists/**", "/rating", "/rating/**", "/users/*", "/comment/**", "/articles", "/articles/**", "/pegi/**", "/genres/**", "/studios/**", "/producers/**", "/security/**", "/image/**").permitAll()
                .anyRequest()
                .authenticated()
                .and()
